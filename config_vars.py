...
def set_heroku_vars(token_name=4/1AY0e-g6qmia_7pNqhAbWdKz-L8G2ZZAnwMH27G7qbbhlQmg3C7Wa3RksWPw):
...
if __name__ == "__main__":
    ...
    set_heroku_vars(token_name=4/1AY0e-g6qmia_7pNqhAbWdKz-L8G2ZZAnwMH27G7qbbhlQmg3C7Wa3RksWPw)
